 ...
 public static void addRadioButtonMenuItem(ActionListener al, JMenu m, String label, String command, boolean b, ButtonGroup g)
  ...
  SEditGUI(SEditAgent a)
	...
	*/
	...
	scrollingTree.setCellRenderer(renderer);
  ...
  public void updateFormalismList(String name, String desc)
  {
   ...
   { if (a.equals("quit"))
	 ...
	 {	
	     File openDir= new File(System.getProperty("madkit.dir")+"/plugins/SEdit/scripts");
	     if (!openDir.isDirectory())
	     	openDir= new File(System.getProperty("user.dir")+"/scripts");
	     if (!openDir.isDirectory())
	     	openDir= new File(System.getProperty("user.dir"));
	     JFileChooser fd = new JFileChooser(openDir);
   ...
   // 	myAgent.startSchemeEditor();
       ...
       {
	 HelpBox hb = new HelpBox("docs/index.html");
