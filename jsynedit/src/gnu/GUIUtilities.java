...
{
  // Jext icon
    private static final Image ICON_IMAGE = null;//UUtilities.getImage("images/window_icon.gif", this);//Jext.class);
  ...
  public static void message(Frame frame, String name, Object[] args)
  {
    JOptionPane.showMessageDialog(frame,
				  /*Jext.getProperty(name.concat(".message"), args)*/name,
				    /* Jext.getProperty(name.concat(".title"), args)*/name,
  ...
  {
    JOptionPane.showMessageDialog(frame,
                                  /*Jext.getProperty(name.concat(".message")name, args)*/name,
				  /*Jext.getProperty(name.concat(".title"), args)*/name,
  ...
  public static SyntaxStyle parseStyle(String str) throws IllegalArgumentException
  {
    ...
    while (st.hasMoreTokens())
    {
      ...
      else if (s.startsWith("style:"))
      {
        ...
        throw new IllegalArgumentException("Invalid directive:o) " + s);
    }
  ...
  public static JMenu loadMenu(String name, boolean isLabel)
  {
    ...
    if (!isLabel)
    {
	label =/* Jext.getProperty(name + ".label")*/name;
      if (label == null)
        label = name;
    }
    else
