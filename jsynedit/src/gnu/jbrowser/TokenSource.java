...
public class TokenSource {
  ...
  public final int getCurrentPos() {
    return currentPos + tokenizerOffset;
  }
...
//%							}
                ...
                currentPos = 0;
                try {
                  st = new StringTokenizer(lineString.substring(tokenizerOffset),
                                           DELIM, true);
                  currentToken = null;
                  ...
                  System.out.println(
                      "Exception caught in TokenSource.getNextToken\n\t"
...
//%		}
  ...
  static class Exception
    ...
    static final String MESSAGE_UNTERM_COMMENT =
