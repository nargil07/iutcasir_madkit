...
public class InsertClassName
  ...
  String fileName;
  /*JextTextArea*/AbstractDoc textArea;
  ...
  public void actionPerformed(ActionEvent evt) {
    ...
    JBrowse.OptionDialog optionDialog = new JBrowse.OptionDialog
        (view, new JBrowse(openAction), "I am a dummy!");
...
// try to expand area if possible...
  ...
  //$$ from Seb [[
  public void reparse(Object src)
  {
  	actionPerformed(new ActionEvent(src, ActionEvent.ACTION_PERFORMED,"reparse"));
  }
  //$$ from Seb ]]
