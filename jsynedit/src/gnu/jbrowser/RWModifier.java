...
//		| STATIC		// except member classes
   ...
   * interface.
   */
  private static final int INVALID_FOR_INTERFACE_METHOD =
      INVALID_FOR_ABSTRACT_METHOD
      | PROTECTED;
  ...
  public static final int setClass(int mod) {
    return (mod | CLASS);
  }

  public static final int setAbstract(int mod) {
    return (mod | ABSTRACT);
  }

  public static final int setFinal(int mod) {
    return (mod | FINAL);
  }

  public static final int setInterface(int mod) {
    return (mod | INTERFACE);
  }

  public static final int setNative(int mod) {
    return (mod | NATIVE);
  }

  public static final int setPrivate(int mod) {
    return (mod | PRIVATE);
  }

  public static final int setProtected(int mod) {
    return (mod | PROTECTED);
  }

  public static final int setPublic(int mod) {
    return (mod | PUBLIC);
  }

  public static final int setStatic(int mod) {
    return (mod | STATIC);
  }

  public static final int setStrict(int mod) {
    return (mod | STRICT);
  }

  public static final int setSynchronized(int mod) {
    return (mod | SYNCHRONIZED);
  }

  public static final int setTransient(int mod) {
    return (mod | TRANSIENT);
  }

  public static final int setVolatile(int mod) {
    return (mod | VOLATILE);
  }
...
//		else if ( isPrivate(mod) )   // error
  ...
  public static final int getMemberVisIndex(int mod) {
    if (isPublic(mod)) {
      return MEMBER_VIS_PUBLIC;
    }
    else if (isProtected(mod)) {
      return MEMBER_VIS_PROTECTED;
    }
    else if (isPrivate(mod)) {
      return MEMBER_VIS_PRIVATE;
    }
    else
    /* package */ {
      return MEMBER_VIS_PACKAGE;
    }
