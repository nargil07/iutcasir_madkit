...
public class UML {
  ...
  static class Element {
    ...
    public final void setParentElement(Element e) {
      this.parent = parent;
    }
    ...
    public final boolean isStatic() {
      return RWModifier.isStatic(mod);
    }

    public final boolean isInterface() {
      return RWModifier.isInterface(mod);
    }

    public final boolean isClass() {
      return RWModifier.isClass(mod);
    }
  ...
  static class Generalization
    ...
    public boolean isVisible(Options.FilterIro filterOpt) {
      ...
      if (filterOpt.getShowGeneralizations()) {
        rVal = true;
      ...
      if (argList != null && displayOpt.getShowArguments()) {
        for (int i = 0; i < argList.size(); i++) {
          if (i > 0) {
            ...
            rVal += ", " +
                ( (Argument) argList.elementAt(i)).toString(displayOpt);
          }
          else {
            // for JDK 1.2 can use argList.get(int)
