...
(defrule startup ""
	...
	(assert (social-goal "%%PROJECT%%" "myGroup" "myRole"))
)

;; correspond roughly to the activate method in other languages
(defrule enteringGroup ""
	...
	(if (not (= ?r 1))
		then
		   (printout t "The group " ?group " has already been created in "?com))
