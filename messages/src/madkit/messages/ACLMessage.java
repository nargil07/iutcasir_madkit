...
public class ACLMessage extends ActMessage
{
  ...
  /** constant identifying the FIPA performative **/
  public static final int INFORM_DONE = 22;
  /** constant identifying the FIPA performative **/
  public static final int INFORM_RESULT = 23;
  ...
  public static final String INFORM_DONE_STRING ="INFORM-DONE";
  public static final String INFORM_RESULT_STRING ="INFORM-RESULT";
  ...
  static { // initialization of the Vector of performatives
    ...
    performatives.add("INFORM-DONE");
    performatives.add("INFORM-RESULT");
  }
